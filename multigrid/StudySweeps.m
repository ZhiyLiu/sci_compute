...
time1_list = zeros(length(r1));
for i = 1: length(r1)
    time1_list(i) = i * time1;
end
time2_list = zeros(length(r2));
for i = 1: length(r2)
    time2_list(i) = i * time2;
end
time3_list = zeros(length(r3));
for i = 1: length(r3)
    time3_list(i) = i * time3;
end
time4_list = zeros(length(r4));
for i = 1: length(r4)
    time4_list(i) = i * time4;
end
time5_list = zeros(length(r5));
for i = 1: length(r5)
