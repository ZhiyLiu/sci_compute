...
*/
    ...
    *************************/
    ...
    residual(u, b.Pointer(), scale, r.Pointer());
...
int main(int argc, char** argv)
{
    ...
    *************************/
    ...
    int v_cycle = 0;
    do{
        recurse(u, b, omega, h, Na, Nb, grid.Origin());

        DTMutableDoubleArray r(b.m(), b.n());
        double inf_norm = residual(u, b.Pointer(), 1/ (h*h), r.Pointer());
        residuals.push_back(inf_norm);
        v_cycle++;
        std::cout << "finish " << v_cycle << " cycle(s)!" << std::endl;
    } while(v_cycle < 1);
